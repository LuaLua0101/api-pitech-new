        ...
        <div class="container">
            ...
            <form action="#" id="iotHubForm" name="iotHubForm">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control custom-input " placeholder="Message" name="content" id="content"
                        rows="3"></textarea>
                </div>
                <button type="submit" class="btn submit-btn text-capitalize">Send message</button>
            </form>
        </div>
    </section>
    <script>
