            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div id="create-news" class="card updates">
                    <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                        <h2 class="h2 bold"><a href="javascript:void(0)">Chỉnh sửa Building</a></h2>
                    </div>
                    <div id="create-box" class="show create-box card-body">
                        <form action="{{route('adpostEditBuilding', ['id' => $news->id])}}" method="POST" id="create-new"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    src="{{asset('/public/img/Building/' .$news->cover)}}" @else class="hidden" @endif >
                                </div>
                            </div>
                            <div class="line"></div>
